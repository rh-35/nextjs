  ...
  return (
    <div className="mt-56 xl:mx-56 mx-10">
        <div className="flex-col items-center space-x-2 justify-center text-center">
            <div className="text-5xl font-bold">Just your stereotypical<div className="bg-gradient-to-r from-blue-400 to-pink-400 inline-block text-transparent bg-clip-text text-5xl font-bold px-2">Transfem</div></div>
