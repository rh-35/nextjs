        ...
        <div className="w-full flex-col overflow-x-hidden mt-32 mb-16">
            <div className="xl:mx-48 2xl:mx-96 mx-10">
                <div className="text-center">
                    ...
                    <p className="">971-279-3325 rheamilberg@gmail.com</p>
                </div>
                <div className="text-left mt-5">
                    <p className="text-2xl font-semibold">Education</p>
                    <p className="text-xl font-semibold">High School Diploma, Lincoln High School</p>
                    <p className="text-l font-semibold">Portland OR, Expected Graduation June 2027</p>
                    <p className="">Highlights of coursework: Lengua y Literatura 5-6, Beginning Audio Engineering</p>
                </div>
                <div className="text-left mt-5">
                    <p className="text-2xl font-semibold">Leadership and Activities</p>
                        <div>
                            <p className="text-xl font-semibold">Run Crew</p>
                                <div className="pl-5">
                                    <p className="text-l font-semibold">Lincoln High School Flock Party, 2024</p>
                        ...
                        <div>
                            <p className="text-xl font-semibold">Sound Tech</p>
                                <div className="pl-5">
                                    <p className="text-l font-semibold">Portland Panto Players, January 2024</p>
                                    <ul className="list-disc pl-5">
                        ...
                        <div>
                            <p className="text-xl font-semibold">Run Crew/Mic Tech</p>
                                <div className="pl-5">
                                    <p className="text-l font-semibold">Lincoln High School Popcycles, 2023</p>
                                    <ul className="list-disc pl-5">
                        ...
                        <div>
                            <p className="text-xl font-semibold">Volunteer and Student Exchange</p>
                                <div className="pl-5">
                                    <p className="text-l font-semibold">Northwest International Exchange, June-July 2023</p>
                                    <ul className="list-disc pl-5">
                    ...
                    <p className="text-2xl font-semibold">Skills and Attributes</p>
                        <div className="pl-5">
                            <ul className="list-disc pl-5">
                                ...
                                <li>Intermediate to advanced level understanding of Java, Javascript, HTML, CSS, Python, PHP, C++</li>
